    ...
    this.route.params.subscribe(
      params => {
        this.notifForm = new FormGroup({
          ...
          iconFile: new FormControl(null, CustomValidation.type(['jpg', 'jpeg', 'png','JPEG', 'JPG', 'PNG'])),
          image: new FormControl(null),
          oldImage: new FormControl(null),
          imageFile: new FormControl(null, CustomValidation.type(['jpg', 'jpeg', 'png','JPEG', 'JPG', 'PNG'])),
