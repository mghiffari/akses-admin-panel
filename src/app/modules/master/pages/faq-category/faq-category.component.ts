...
export class FaqCategoryComponent implements OnInit {
  ...
  private table: any;
  @ViewChild('categoryfaqsTable') set tabl(table: ElementRef) {
    this.table = table;
  }
  ...
  gotoDetail = (element) => {
    ...
    this.router.navigate(['master/categoryfaq/edit', element.id])
  }

  createCategory = () => {
    this.router.navigate(["/master/categoryfaq/create"])
