...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren:
          "./modules/payment-instruction/pay-inst.module#PayInstModule"
      },
      {
        path: "notifications",
        loadChildren:
      ...
      },
      {
        ...
        loadChildren:
          "./modules/user-management/user-management.module#UserManagementModule"
      },
      {
        path: "report",
      ...
      },
      {
        ...
        loadChildren:
          "./modules/maintenance/maintenance.module#MaintenanceModule"
      }
    ]
  },
  {
